...
| `npm test` | كل الاختبارات (الواجهة البرمجية، الأمان، التشغيل والإيقاف، ووحدات الواجهة) — 89 اختبارًا. |
...
| `/app` | اليوم: ما تذاكره الآن (أو الجولة الجارية)، خط زمني ليومك يجمع جولاتك ومحاضراتك الجامعية، ما بعده والمواعيد القادمة، ثم التقدّم |
...
| `/app/timer`، `/app/stats`، `/app/settings` | وضع التركيز، الإحصائيات، الإعدادات |

في التطبيق: `Ctrl+K` (أو `/`) يفتح البحث في المواد والمحاضرات والالتزامات والصفحات.
